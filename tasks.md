...
1. C# с исключениями
    * С#, один класс в котором Main и другие методы и поля. Рекурсия, стандартные конструкции, присваивание. Анонимные лямбды не надо.
    ...
    * Try/Catch/finally, фильтры исключений
      * Чтонить для открытия и записи в файл, чтобы можно было проверить, что в finally файл действительно закрывается.
